...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('wasted')
		.setDescription('The classic GTA 5 wasted meme!.')
	...
	async execute(interaction) {
		try {
            ...
            const link = `https://some-random-api.ml/canvas/wasted?avatar=${Member.user.displayAvatarURL({ dynamic: true, format: 'png' })}`
